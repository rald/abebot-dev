...
void render() {
	SDL_Color bgcolor={0x00,0x00,0x00,0xFF};
 	...
 	imgui_prepare();
		modeSelectButtonClicked=button(GEN_ID,SCREEN_WIDTH-16,SCREEN_HEIGHT-16,modeSelectSprite,palette);
	imgui_finish();
...
int main(int argc,char *argv[]) {
	...
	modeSelectSprite=Canvas_Load("ModeSelectButton.cvs");
